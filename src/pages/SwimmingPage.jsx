...
import { FaTimes } from 'react-icons/fa'; // Make sure to import FaTimes for closing the modal
...
const CoachCard = () => (
  <div className="bg-white rounded-lg shadow-lg max-w-4xl mx-auto p-8">
    <div className="flex flex-col md:flex-row items-center">
      <div className="w-full md:w-1/2 p-4">
        <img className="w-full h-64 object-cover rounded-lg shadow-md" src="/coach-photo.jpg" alt="Coach Image" />
      </div>
      <div className="w-full md:w-1/2 p-4">
        <h2 className="text-3xl font-bold text-primary">SARAH JONES</h2>
        <h3 className="text-xl text-secondary-foreground">HEAD COACH</h3>
        <p className="mt-4 text-muted-foreground">
          Sarah Jones has been coaching swimming for over a decade, focusing on stroke techniques and competitive strategies.
        </p>
        <div className="mt-4 text-sm text-gray-600">
          <p><strong>Date of birth:</strong> 15 January 1980</p>
          <p><strong>Place of birth:</strong> Sydney, Australia</p>
