...
import { FaPaperPlane, FaSearch, FaFilter, FaUser, FaUserMd, FaUserTie, FaUsers, FaBell, FaBellSlash } from "react-icons/fa";
...
const Messages = () => {
  ...
  return (
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className={`md:w-64 bg-gray-50 rounded-lg p-4 ${showMobileFilters ? "block" : "hidden md:block"}`}>
        ...
        <div className="flex-1">
          ...
          {/* Messages List */}
          <div className="mb-6 max-h-96 overflow-y-auto border rounded-lg divide-y">
            {filteredMessages.length === 0 ? (
              ...
              filteredMessages.map((message) => (
                <div
                  key={message.id}
                  className={`p-4 hover:bg-gray-50 transition ${!message.read ? "bg-blue-50" : ""} ${getPriorityColor(message.priority)}`}
                ...
                >
                  ...
                  <p className="mt-2 text-gray-700 pl-13">{message.content}</p>
                </div>
              ))
            )}
