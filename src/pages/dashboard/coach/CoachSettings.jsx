...
import { FaUserCog, FaLock, FaBell, FaUserShield, FaCalendarAlt, FaChalkboardTeacher, FaLanguage, FaPalette } from 'react-icons/fa';
...
const CoachSettings = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: 'm.johnson@elitecoaching.com',
    ...
    coachingApproach: 'Performance-focused',
    certification: 'ICF Certified',
    hourlyRate: 120
  });
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <div className="flex items-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-800">Coach Settings</h1>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-64 bg-white rounded-lg shadow-md p-4 h-fit">
          ...
          <div 
            className={`flex items-center p-3 rounded-lg cursor-pointer mb-2 ${activeTab === 'availability' ? 'bg-blue-50 text-blue-600' : 'hover:bg-gray-50'}`}
          ...
          <div 
            className={`flex items-center p-3 rounded-lg cursor-pointer mb-2 ${activeTab === 'coaching' ? 'bg-blue-50 text-blue-600' : 'hover:bg-gray-50'}`}
          ...
          {activeTab === 'coaching' && (
            <div>
              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Coaching Approach</label>
                  <select
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <input
                        ...
                        defaultChecked
                      />
                      <label htmlFor="quick-new-client">New Client</label>
                    </div>
                    <div className="flex items-center">
                      <input
                        type="checkbox"
                        ...
                        defaultChecked
                      />
                      <label htmlFor="quick-new-session">New Session</label>
                    </div>
                    <div className="flex items-center">
                      <input
                        type="checkbox"
                        ...
                        className="mr-2"
                      />
                      <label htmlFor="quick-schedule">Schedule Session</label>
                    </div>
                  </div>
                </div>
              </div>
